        ...
        ("group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium"
            ...
            {!!id && (
                <div role="button" className="h-full rounded-sm  hover:bg-neutral-300 dark:bg-neutral-600 mr-1" onClick={handleExpand}>
                    <ChevronIcon
                    className="h-4 shrink-0 text-muted-foreground/50 w-4"
                    />
                </div>
            ...
            {isSearch && (
                <kbd className="px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100 ml-auto pointer-events-none inline-flex h-5 select-none items-center gap-0 rounded-border bg-muted">
