                ...
                {initialData.isPublished ? (
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center ">
                            <input disabled className="flex-1 px-2 text-xs border rounded-l-md h-8 bg-muted truncate" value={url}/>
                        ...
                        <Button className="w-full text-xs" disabled={isSubmitting} size="sm" onClick={onUnPublish}>
                            Unpublish
                        </Button>
                    </div>
                ) : (
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <Button disabled={isSubmitting} onClick={onPublish} size="sm" className="w-full text-xs">
                            Publish
                        </Button>
                    </div>
                )}
